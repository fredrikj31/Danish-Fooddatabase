...
senatorwiki = 'http://localhost:8080/Fooddatabase/grønt.html'
...
for row in rows:
	...
	sql = "INSERT INTO grøntsager (Id, Fødevare, Kcal, KJ, Protein, Fedt, Kulhydrat, Kostfibre, Calcium) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
