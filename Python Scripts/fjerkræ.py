...
senatorwiki = 'http://localhost:8080/Fooddatabase/fjerkræ.html'
...
for row in rows:
	...
	sql = "INSERT INTO fjerkræ (Id, Fødevare, Kcal, KJ, Protein, Fedt, Kulhydrat, Kostfibre, Calcium) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
