...
senatorwiki = 'http://localhost:8080/Fooddatabase/korn.html'
...
for row in rows:
	...
	sql = "INSERT INTO kornprodukter (Id, Fødevare, Kcal, KJ, Protein, Fedt, Kulhydrat, Kostfibre, Calcium) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
