...
senatorwiki = 'http://localhost:8080/Fooddatabase/majeri.html'
...
for row in rows:
	...
	sql = "INSERT INTO majeriprodukter (Id, Fødevare, Kcal, KJ, Protein, Fedt, Kulhydrat, Kostfibre, Calcium) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
