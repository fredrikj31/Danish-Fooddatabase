...
senatorwiki = 'http://localhost:8080/Fooddatabase/nødder.html'
...
for row in rows:
	...
	sql = "INSERT INTO nødder (Id, Fødevare, Kcal, KJ, Protein, Fedt, Kulhydrat, Kostfibre, Calcium) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
