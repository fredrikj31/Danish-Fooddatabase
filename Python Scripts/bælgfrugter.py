...
senatorwiki = 'http://localhost:8080/Fooddatabase/bælgfrugter.html'
...
for row in rows:
	...
	sql = "INSERT INTO bælgfrugter (Id, Fødevare, Kcal, KJ, Protein, Fedt, Kulhydrat, Kostfibre, Calcium) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
