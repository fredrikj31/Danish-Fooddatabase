...
senatorwiki = 'http://localhost:8080/Fooddatabase/fisk.html'
...
for row in rows:
	...
	sql = "INSERT INTO fisk (Id, Fødevare, Kcal, KJ, Protein, Fedt, Kulhydrat, Kostfibre, Calcium) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
